  ...
  return (
    <div className="animate-fade-up">
      ...
      <form onSubmit={handleEmailLogin} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <Link
              ...
              className="text-xs text-brand-purple hover:text-brand-mint transition-colors"
            >
              Esqueceu a senha?
            </Link>
          </div>
        ...
        {error && (
          <div className="px-4 py-3 rounded-xl bg-brand-pink/10 border border-brand-pink/20 text-brand-pink text-sm">
            {error}
          </div>
        )}
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full btn-gradient py-3.5 text-sm disabled:opacity-50"
        >
          {loading ? (
      ...
      <p className="text-center text-sm text-text-muted mt-6">
        ...
        <Link
          href="/auth/register"
          className="text-brand-purple hover:text-brand-mint font-medium transition-colors"
        >
          Criar conta grátis
        </Link>
      </p>
